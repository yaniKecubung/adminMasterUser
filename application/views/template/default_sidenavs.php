			...
			<div class="menu_section">
				...
				<ul class="nav side-menu">
					...
					<li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="<?php echo base_url('Home/form_ex') ?>">General Form</a></li>
							<li><a href="<?php echo base_url('Home/table_ex') ?>">Table</a></li>
							<li><a href="<?php echo base_url('Home/table_dyn_ex') ?>">Table Dynamics</a></li>
						</ul>
					</li>
